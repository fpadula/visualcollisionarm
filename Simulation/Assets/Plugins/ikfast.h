...
public:
  ...
  typedef int (*UnityIkFn)(double*, double*, double*, bool, int, double, double, double, double, bool);
  UnityIkFn _UnityIk;
};
...
/// \brief Unity test
IKFAST_API int UnityIk(IkReal*, IkReal*, IkReal*, bool, int, IkReal, IkReal, IkReal, IkReal, bool);
